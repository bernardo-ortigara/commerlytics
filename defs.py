...
def gera_relatorio():
    print('======== <<< ''\033[1;37;40m''GERAR RELATÓRIO DE VENDAS''\033[0;0m >>> ========')
    print('')
    ...
    print(f"Total Geral de Vendas: R$ {relatorio_dados['total_geral_vendas']:.2f}")
    print(f"Total Geral de Itens Vendidos: {relatorio_dados['total_geral_itens_vendidos']}")
    ...
    print("\n--- Análises Adicionais ---")
    print("  Top 5 Clientes com Maior Gasto:")
    if relatorio_dados['analises_adicionais']['top_5_clientes_maior_gasto']:
        ...
        print("    Nenhum cliente com gasto registrado.")

    print("  Canais Mais Vendidos:")
    if relatorio_dados['analises_adicionais']['canais_mais_vendidos']:
        ...
        print("    Nenhum canal de venda registrado.")
